...
DATA_FOLDER = "/home/lsy/Code/CZSL_models/data"  # change to your dataset path
...
parser.add_argument('--use_gfn', action='store_true', default=True, help='use global_filter_network')
parser.add_argument('--gfn_arch', default='gfnet-h-ti', help='choose the gfn arch')
...
parser.add_argument('--attr_score_weight', type=float, default= 1.0, help="Scale for cosine similarity")
# Hyperparameters
